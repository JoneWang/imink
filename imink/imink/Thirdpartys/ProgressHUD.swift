// Srouce: https://github.com/relatedcode/ProgressHUD
//
...
public class ProgressHUD: UIView {
    ...
    private var colorProgress    = UIColor.label
    ...
    private func hudShow() {
        ...
        if (self.alpha != 1) {
            self.alpha = 1
            toolbarHUD?.alpha = 0
            toolbarHUD?.transform = CGAffineTransform(scaleX: 0.7, y: 0.7)

            // UIView.animate(withDuration: 0.25, delay: 0, options: [.allowUserInteraction, .curveEaseIn], animations: {
            UIView.animate(withDuration: 0.35, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.7, options: .curveEaseIn, animations: {
                self.toolbarHUD?.transform = CGAffineTransform(scaleX: 1, y: 1)
